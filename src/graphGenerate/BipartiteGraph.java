...
public class BipartiteGraph
{
	/**
	 * 
	 * @param n: node count on source side
	 * @param m: node count on sink side
	 * @param maxCapacity
	 * @param minCapacity
	 * @param filename 
	 * @param max_prob
	 * @throws Exception
	 */
	public void graphGenerator(int n, int m, 
			int maxCapacity, 
			 int minCapacity, double maxProbability, String filename) throws Exception {
