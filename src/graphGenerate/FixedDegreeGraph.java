...
public class FixedDegreeGraph {
	 ...
	 * @param filename - path and file name for saving the graph
	 */
	public void graphGenerator(int v, int e, int minCapacity, 
			int maxCapacity, String filename){
		toFile(graphBuilder(v,e,minCapacity,maxCapacity), filename);
